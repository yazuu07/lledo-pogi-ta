...
<head>
    ...
    background: #222;
        ...
        .capture-btn:active, .retake-btn:active, .confirm-btn:active { background: lightgray; }
        .capture-btn::before { 
            content: "Capture";
            position: absolute;
            top: -30px;
...
<body>
    ...
    <a href="cam_overtime.php" id="myLink">Overtime</a>
    <a href="cam_undertime.php" id="myLink2">Undertime</a>
    ...
    <div class="camera-container">
      ...
      <button id="switchCamera" class="capture-btn" style="left: 20%;"></button>
    ...
    const logoHeight = 10; // Adjust size as needed
