...
<head>
    ...
    background: #222;
        ...
        canvas { display: none; }
        .Undertime-btn, .retake-btn, .confirm-btn { 
            position: absolute;
            bottom: 35px;
        ...
        .Undertime-btn { left: 50%; }
        .retake-btn { left: 32%; display: none; }
        .confirm-btn { right: 20%; display: none; }
        .Undertime-btn:active, .retake-btn:active, .confirm-btn:active { background: lightgray; }
        .Undertime-btn::before { 
            content: "Undertime";
            position: absolute;
            top: -30px;
            left: 50%;
...
<body>
    ...
    <a href="cam_capture.php" id="myLink">Capture</a>
    <a href="cam_overtime.php" id="myLink2">Overtime</a>
    ...
    <div class="camera-container">
        ...
        <button id="Undertime" class="Undertime-btn"></button>
        
        <button id="retake" class="retake-btn"></button>
        <button id="confirm" class="confirm-btn"></button>
      <button id="switchCamera" class="Undertime-btn" style="left: 20%;"></button>
...
switchCameraButton.addEventListener("click", () => {
    ...
    navigator.geolocation.getCurrentPosition(async (position) => {
        ...
        function updateBrightnessCheck() {
            ...
            if (brightness < 50) { 
                ...
                UndertimeBtn.disabled = true;
                UndertimeBtn.style.opacity = "0.5";
            } else {
                warning.style.display = "none";
                UndertimeBtn.disabled = false;
                UndertimeBtn.style.opacity = "1";
            }
        }

        setInterval(updateBrightnessCheck, 1000);
        
        UndertimeBtn.addEventListener("click", () => {
            if (UndertimeBtn.disabled) return;
    ...
    document.getElementById("myLink2").style.display = "none";
            ...
            UndertimeBtn.style.display = "none";
        ...
        retakeBtn.addEventListener("click", () => {
            ...
            UndertimeBtn.style.display = "block";
